<template>
  <div class="box1001">
    ...
    <div class="box1003">
      ...
      <div class="box1005">
        <div id="app2">
          <el-button type="primary" @click="dialogFormVisible = true" >添加字段</el-button>
    ...
    <el-button type="primary" @click="dialogFormVisible = false">保存</el-button>
      ...
      <div class="box10014">
        <el-table :data="tableData" stripe height="550" style="width: 100%">
          ...
          <el-table-column prop="choose" label="是否必填" width="150">
          </el-table-column>
  ...
  <el-form-item label="文本类型">
   ...
   <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="dialogFormVisible = false">保存</el-button>
        ...
        <el-button type="text" @click="open3">上移</el-button>
          </el-table-column>
        </el-table>
        <div class="dibu002">
