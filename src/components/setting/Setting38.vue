<template>
  <div class="workspace">
   ...
   <div class="header" style=" width: 1040px ; margin-left: 310px ">
       <el-select  style=" width: 140px " v-model="value" placeholder="全部终端">
    <el-option
      ...
      ></el-input>
      <el-button style="width: 60px" type="primary">搜索</el-button>
      <el-button style="width: 120px; float: right ">导出数据</el-button>
      <el-button style="width: 120px; float: right ">批量解禁</el-button>
      <router-view />
    
    <el-table :data="index" style="width:1040px ; margin-top: 20px;  ">
        <el-table-column
      type="selection"
      width="55">
    </el-table-column>
      <el-table-column prop="name" label="客户名称" width="143" > </el-table-column>
      <el-table-column prop="origin" label="真实姓名" width="107"> </el-table-column>
      <el-table-column prop="terminal" label="电话" width="107">
      </el-table-column>
      <el-table-column prop="time" label="邮箱" width="107"> </el-table-column>
         <el-table-column prop="a" label="客户等级" width="197"> </el-table-column>
            <el-table-column prop="b" label="客户来源" width="187"> </el-table-column>
             

      <el-table-column prop="status" label="操作" width="133">

        
        <el-button type="text"  @click=" $router.push({path:'/main/customer/detail'})"  >详情</el-button>
        <router-view />
        
        <el-button type="text" @click="open2">解禁</el-button>
      ...
      index: [
        {
          name: "河北省秦皇岛市客户",
          origin: "林芳",
          terminal: "18845678900",
          time: "1190887@163.com",
          a: "普通用户",
          b: "2019/9/12 10：99",
